 ...
 *
 * <p> {@code List}s are data structures that store an ordered collection of
 ...
 *
 * <p> {@code List}s also extend the {@link Iterable} interface to allow
 * iteration of elements through an {@link java.util.Iterator Iterator}. The
 * iterator will also be defined by the user.
 *
